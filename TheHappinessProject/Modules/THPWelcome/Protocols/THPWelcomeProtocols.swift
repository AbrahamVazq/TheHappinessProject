...
// MARK: VIEW -> PRESENTER
protocol THPWelcome_ViewToPresenterProtocol: AnyObject {
	var view: THPWelcome_PresenterToViewProtocol? { get set }
	var interactor: THPWelcome_PresenterToInteractorProtocol? { get set }
	var router: THPWelcome_PresenterToRouterProtocol? { get set }
}
...
protocol THPWelcome_PresenterToInteractorProtocol: AnyObject {
    var presenter: THPWelcome_InteractorToPresenterProtocol? { get set }
}
...
protocol THPWelcome_InteractorToPresenterProtocol: AnyObject {
}
...
// MARK: PRESENTER -> VIEW
protocol THPWelcome_PresenterToViewProtocol: AnyObject {
    var presenter: THPWelcome_ViewToPresenterProtocol? { get set }
}
...
protocol THPWelcome_PresenterToRouterProtocol: AnyObject {
}
