...
// MARK: VIEW -> PRESENTER
protocol THPCategories_ViewToPresenterProtocol: AnyObject {
	var view: THPCategories_PresenterToViewProtocol? { get set }
	var interactor: THPCategories_PresenterToInteractorProtocol? { get set }
	var router: THPCategories_PresenterToRouterProtocol? { get set }
}
...
protocol THPCategories_PresenterToInteractorProtocol: AnyObject {
    var presenter: THPCategories_InteractorToPresenterProtocol? { get set }
}
...
protocol THPCategories_InteractorToPresenterProtocol: AnyObject {
}
...
// MARK: PRESENTER -> VIEW
protocol THPCategories_PresenterToViewProtocol: AnyObject {
    var presenter: THPCategories_ViewToPresenterProtocol? { get set }
}
...
protocol THPCategories_PresenterToRouterProtocol: AnyObject {
}
