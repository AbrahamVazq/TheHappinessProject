...
// MARK: VIEW -> PRESENTER
protocol THPOurProducts_ViewToPresenterProtocol: AnyObject {
	var view: THPOurProducts_PresenterToViewProtocol? { get set }
	var interactor: THPOurProducts_PresenterToInteractorProtocol? { get set }
	var router: THPOurProducts_PresenterToRouterProtocol? { get set }
}
...
protocol THPOurProducts_PresenterToInteractorProtocol: AnyObject {
    var presenter: THPOurProducts_InteractorToPresenterProtocol? { get set }
}
...
protocol THPOurProducts_InteractorToPresenterProtocol: AnyObject {
}
...
// MARK: PRESENTER -> VIEW
protocol THPOurProducts_PresenterToViewProtocol: AnyObject {
    var presenter: THPOurProducts_ViewToPresenterProtocol? { get set }
}
...
protocol THPOurProducts_PresenterToRouterProtocol: AnyObject {
}
